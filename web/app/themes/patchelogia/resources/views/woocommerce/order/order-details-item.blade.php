...
<div
    class="{{ esc_attr(apply_filters('woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order)) }} flex justify-between gap-x-2">
    <span class="woocommerce-table__product-name product-name">
        @php
