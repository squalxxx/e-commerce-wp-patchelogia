...
<section class="order-details woocommerce-order-details mb-8 rounded-2xl border border-zinc-200 p-8">
    ...
    <div class="woocommerce-table woocommerce-table--order-details shop_table order_details">
        ...
        <div class="flex flex-col gap-y-3">
            @foreach ($order->get_order_item_totals() as $key => $total)
                <div @class([
                    ...
                    'font-medium' =>
                        $total['type'] === 'total' || $total['type'] === 'payment_method',
                ])>
                    <span>
        ...
        @if ($order->get_customer_note())
            <div class="mt-6 flex flex-col">
                <span>
                    @php esc_html_e('Note:', 'woocommerce') @endphp
                </span>
