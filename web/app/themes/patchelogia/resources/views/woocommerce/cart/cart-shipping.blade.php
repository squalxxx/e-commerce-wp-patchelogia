...
<div class="woocommerce-shipping-totals shipping flex flex-col gap-y-1">
    ...
    <div data-title="{{ esc_attr($package_name) }}">
        @if (!empty($available_methods) && is_array($available_methods))
            ...
            @if (is_cart())
                <p class="woocommerce-shipping-destination text-xs">
                    @php
